...
public class MyDatabaseManager implements AbsManager {
	...
	public static final String TABLE_NAME = "myweibo";
	...
	public static class MyDbColumns implements BaseColumns {
		...
		public static final String ACCESS_TOKEN = "url";
	...
	static {
		...
		stringBuilder.append(MyDbColumns.ACCESS_TOKEN + " CHAR");
		stringBuilder.append(")");
	...
	public static void saveMytable(Context context, int id, String name, String url, int phoneNum) {
		...
		contentValues.put(MyDbColumns.ACCESS_TOKEN, url);
